...
//! A pumpkin is a vernacular term for mature winter squash of species and varieties in the genus Cucurbita that has culinary and cultural significance
//! but no agreed upon botanical or scientific meaning.
//! The term pumpkin is sometimes used interchangeably with "squash" or "winter squash", and is commonly used for cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima, Cucurbita moschata, and Cucurbita pepo.
...
/// `BURNT_ORANGE` is for `orangeness` field in the Pumpkin struct.
...
// Answer: cargo doc --document-private-items --no-deps --open
